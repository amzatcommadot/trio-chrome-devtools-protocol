...
async def print_to_pdf(
    ...
    return await session.execute(cdp.page.print_to_pdf(landscape, display_header_footer, print_background, scale, paper_width, paper_height, margin_top, margin_bottom, margin_left, margin_right, page_ranges, header_template, footer_template, prefer_css_page_size, transfer_mode))
