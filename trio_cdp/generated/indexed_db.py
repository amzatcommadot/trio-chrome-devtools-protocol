...
async def clear_object_store(
    ...
    return await session.execute(cdp.indexed_db.clear_object_store(database_name, object_store_name, security_origin, storage_key))
...
async def delete_database(
    ...
    return await session.execute(cdp.indexed_db.delete_database(database_name, security_origin, storage_key))
...
async def delete_object_store_entries(
    ...
    return await session.execute(cdp.indexed_db.delete_object_store_entries(database_name, object_store_name, key_range, security_origin, storage_key))
...
async def get_metadata(
    ...
    return await session.execute(cdp.indexed_db.get_metadata(database_name, object_store_name, security_origin, storage_key))
...
async def request_data(
    ...
    return await session.execute(cdp.indexed_db.request_data(database_name, object_store_name, index_name, skip_count, page_size, security_origin, storage_key, key_range))
...
async def request_database(
    ...
    return await session.execute(cdp.indexed_db.request_database(database_name, security_origin, storage_key))
...
async def request_database_names(
    ...
    return await session.execute(cdp.indexed_db.request_database_names(security_origin, storage_key))
